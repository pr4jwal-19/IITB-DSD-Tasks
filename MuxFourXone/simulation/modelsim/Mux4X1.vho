...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((\datau[0]~0_combout\ & (((\dut_instance|add_instance|Y~1\ & !\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\)))) # (!\datau[0]~0_combout\ & (datau(0))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	...
	datab => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irsr_reg[4]~1_combout\,
	datac => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|irsr_reg\(4),
	datad => datau(0),
	aclr => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|sldfabric|jtag_hub_gen:real_sld_jtag_hub|clr_reg~regout\,
	sload => VCC,
...
\data[5]\ : maxv_lcell
-- Equation(s):
-- data(5) = DFFEAS(GND, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \shift_reg~1_combout\, 
...
-- Equation(s):
-- \dut_instance|add_instance|Y~0\ = (dut_input(0) & (((dut_input[2]) # (!dut_input(1))))) # (!dut_input(0) & (dut_input(3) & ((dut_input(1)))))
...
-- Equation(s):
-- \dut_instance|add_instance|Y~1\ = (dut_input(1) & (\dut_instance|add_instance|Y~0\)) # (!dut_input(1) & ((\dut_instance|add_instance|Y~0\ & (dut_input[4])) # (!\dut_instance|add_instance|Y~0\ & ((dut_input(5))))))
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|Y~1\,
	oe => VCC,
