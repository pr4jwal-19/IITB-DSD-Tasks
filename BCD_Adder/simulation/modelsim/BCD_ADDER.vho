...
SIGNAL \dut_instance|add_instance|inst2|Sum~0\ : std_logic;
...
SIGNAL \dut_instance|add_instance|inst2|Cout~0\ : std_logic;
SIGNAL \dut_instance|add_instance|inst3|Cout~0\ : std_logic;
...
-- Equation(s):
-- \dut_instance|add_instance|inst2|Sum~0\ = dut_input(1) $ (dut_input(5) $ (((dut_input(4) & dut_input[0]))))
-- dut_input(0) = DFFEAS(\dut_instance|add_instance|inst2|Sum~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst2|Sum~0\,
	regout => dut_input(0));

-- Location: LC_X6_Y5_N3
\dut_input[4]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|inst2|Cout~0\ = (dut_input(1) & ((dut_input(5)) # ((dut_input(0) & dut_input[4])))) # (!dut_input(1) & (dut_input(0) & (dut_input[4] & dut_input(5))))
-- dut_input(4) = DFFEAS(\dut_instance|add_instance|inst2|Cout~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst2|Cout~0\,
	regout => dut_input(4));
...
-- Equation(s):
-- \shift_reg~2_combout\ = (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & (\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_cdr~0_combout\ & ((\io~regout\))))
...
-- Equation(s):
-- \dut_instance|add_instance|inst3|Cout~0\ = ((dut_input(6) & ((dut_input[2]) # (\dut_instance|add_instance|inst2|Cout~0\))) # (!dut_input(6) & (dut_input[2] & \dut_instance|add_instance|inst2|Cout~0\)))
-- dut_input(2) = DFFEAS(\dut_instance|add_instance|inst3|Cout~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	datab => dut_input(6),
	datac => data(2),
	datad => \dut_instance|add_instance|inst2|Cout~0\,
	aclr => GND,
	sload => VCC,
	ena => \shift_reg~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|inst3|Cout~0\,
	regout => dut_input(2));

-- Location: LC_X6_Y5_N7
\dut_input[6]\ : maxv_lcell
-- Equation(s):
-- \datau[2]~2\ = (!\dut_instance|add_instance|inst2|Sum~0\ & (dut_input(2) $ (dut_input[6] $ (!\dut_instance|add_instance|inst2|Cout~0\))))
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|inst2|Sum~0\,
	datab => dut_input(2),
	datac => data(6),
	datad => \dut_instance|add_instance|inst2|Cout~0\,
	aclr => GND,
...
-- Equation(s):
-- \datau[3]~10\ = (dut_input(7) & (\dut_instance|add_instance|inst3|Cout~0\ $ (((\datau[2]~2\))))) # (!dut_input(7) & ((\dut_instance|add_instance|inst3|Cout~0\ & ((\datau[2]~2\))) # (!\dut_instance|add_instance|inst3|Cout~0\ & (dut_input[3] & 
-- !\datau[2]~2\))))
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => dut_input(7),
	datab => \dut_instance|add_instance|inst3|Cout~0\,
	datac => data(3),
	datad => \datau[2]~2\,
	aclr => GND,
	sload => VCC,
...
-- Equation(s):
-- \dut_instance|add_instance|inst8|Y~0\ = (dut_input(3) & (((dut_input[7]) # (\dut_instance|add_instance|inst3|Cout~0\)) # (!\datau[2]~2\))) # (!dut_input(3) & ((\datau[2]~2\ & (dut_input[7] & \dut_instance|add_instance|inst3|Cout~0\)) # (!\datau[2]~2\ & 
-- ((dut_input[7]) # (\dut_instance|add_instance|inst3|Cout~0\)))))
...
PORT MAP (
	...
	datab => \datau[2]~2\,
	datac => data(7),
	datad => \dut_instance|add_instance|inst3|Cout~0\,
	aclr => GND,
	sload => VCC,
	ena => \shift_reg~0_combout\,
	devclrn => ww_devclrn,
...
\datau[4]\ : maxv_lcell
-- Equation(s):
-- datau(4) = DFFEAS((\shift_reg~2_combout\ & (\dut_instance|add_instance|inst8|Y~0\)) # (!\shift_reg~2_combout\ & (((datau(4) & !\shift_reg~3_combout\)))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|inst8|Y~0\,
	datab => datau(4),
...
-- Equation(s):
-- \datau[2]~6_combout\ = dut_input(2) $ (\dut_instance|add_instance|inst2|Cout~0\ $ (((!\dut_instance|add_instance|inst2|Sum~0\ & \dut_instance|add_instance|inst8|Y~0\))))
...
PORT MAP (
	dataa => dut_input(2),
	datab => \dut_instance|add_instance|inst2|Sum~0\,
	datac => \dut_instance|add_instance|inst8|Y~0\,
	datad => \dut_instance|add_instance|inst2|Cout~0\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\datau[2]\ : maxv_lcell
-- Equation(s):
-- datau(2) = DFFEAS((\shift_reg~2_combout\ & (dut_input(6) $ (((\datau[2]~6_combout\))))) # (!\shift_reg~2_combout\ & (((datau(3))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~4_combout\, , , , )
...
\datau[1]\ : maxv_lcell
-- Equation(s):
-- datau(1) = DFFEAS((\shift_reg~2_combout\ & (\dut_instance|add_instance|inst8|Y~0\ $ ((\dut_instance|add_instance|inst2|Sum~0\)))) # (!\shift_reg~2_combout\ & (((datau(2))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~4_combout\, , , , )
...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((\shift_reg~2_combout\ & ((dut_input(4) $ (dut_input(0))))) # (!\shift_reg~2_combout\ & (datau(1))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[0]~4_combout\, , , , )
