...
SIGNAL \dut_instance|add_instance|carry~1\ : std_logic;
SIGNAL \dut_instance|add_instance|Mux0~0\ : std_logic;
SIGNAL \dut_instance|add_instance|Mux7~1\ : std_logic;
SIGNAL \dut_instance|add_instance|shiftedOp~2\ : std_logic;
SIGNAL \dut_instance|add_instance|Mux7~0\ : std_logic;
SIGNAL \dut_instance|add_instance|Mux7~2\ : std_logic;
SIGNAL \dut_instance|add_instance|xoredOp~0\ : std_logic;
SIGNAL \shift_reg~2_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|temp_diff~2_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|Mux4~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|shiftedOp~7_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|shiftedOp~9_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|shiftedOp~10_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|Mux4~1_combout\ : std_logic;
...
SIGNAL \datau[4]~3_combout\ : std_logic;
SIGNAL \datau[5]~4_combout\ : std_logic;
SIGNAL \datau[4]~1_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|temp_diff~1_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|Mux5~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|xoredOp~1_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|shiftedOp~6_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|shiftedOp~4_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|shiftedOp~5_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|shiftedOp~8_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|Mux5~1_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|Mux6~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|shiftedOp~3\ : std_logic;
SIGNAL \dut_instance|add_instance|shiftedOp~11_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|shiftedOp~12_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|temp_diff~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|Mux6~1_combout\ : std_logic;
SIGNAL \datau[0]~0_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|Mux7~3_combout\ : std_logic;
...
SIGNAL \dut_instance|add_instance|Mux0~1\ : std_logic;
...
SIGNAL \ALT_INV_shift_reg~3_combout\ : std_logic;
...
\ALT_INV_shift_reg~3_combout\ <= NOT \shift_reg~3_combout\;
...
-- Equation(s):
-- \dut_instance|add_instance|Mux7~1\ = (dut_input(3) & ((dut_input(1) & (dut_input(7))) # (!dut_input(1) & ((dut_input[5])))))
-- dut_input(5) = DFFEAS(\dut_instance|add_instance|Mux7~1\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|Mux7~1\,
	regout => dut_input(5));

-- Location: LC_X13_Y8_N0
\dut_input[1]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|carry~0\ = (dut_input(5) & (!dut_input(4) & (dut_input[1] & dut_input(0)))) # (!dut_input(5) & ((dut_input[1]) # ((!dut_input(4) & dut_input(0)))))
-- dut_input(1) = DFFEAS(\dut_instance|add_instance|carry~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
-- Equation(s):
-- \dut_instance|add_instance|shiftedOp~2\ = (((dut_input[6] & dut_input(3))))
-- dut_input(6) = DFFEAS(\dut_instance|add_instance|shiftedOp~2\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|shiftedOp~2\,
	regout => dut_input(6));

-- Location: LC_X10_Y8_N3
\dut_input[2]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|carry~1\ = (\dut_instance|add_instance|carry~0\ & (((dut_input[2]) # (!dut_input(6))))) # (!\dut_instance|add_instance|carry~0\ & (((dut_input[2] & !dut_input(6)))))
-- dut_input(2) = DFFEAS(\dut_instance|add_instance|carry~1\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|carry~0\,
	datac => data(2),
	datad => dut_input(6),
	aclr => GND,
	sload => VCC,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|carry~1\,
	regout => dut_input(2));

-- Location: LC_X10_Y8_N5
\dut_input[8]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Mux0~0\ = (dut_input[8] & ((dut_input(7) & (dut_input(3) & \dut_instance|add_instance|carry~1\)) # (!dut_input(7) & ((dut_input(3)) # (\dut_instance|add_instance|carry~1\)))))
-- dut_input(8) = DFFEAS(\dut_instance|add_instance|Mux0~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	datab => dut_input(3),
	datac => data(8),
	datad => \dut_instance|add_instance|carry~1\,
	aclr => GND,
	sload => VCC,
	ena => \shift_reg~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|Mux0~0\,
	regout => dut_input(8));

-- Location: LC_X13_Y8_N5
\dut_input[9]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Mux7~2\ = (dut_input[9] & ((\dut_instance|add_instance|Mux7~0\) # ((\dut_instance|add_instance|Mux7~1\ & dut_input(0))))) # (!dut_input[9] & (((dut_input(0)))))
-- dut_input(9) = DFFEAS(\dut_instance|add_instance|Mux7~2\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|Mux7~0\,
	datab => \dut_instance|add_instance|Mux7~1\,
	datac => data(9),
	datad => dut_input(0),
	aclr => GND,
	sload => VCC,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|Mux7~2\,
	regout => dut_input(9));

-- Location: LC_X10_Y8_N0
\dut_input[7]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Mux0~1\ = (!dut_input(9) & ((\dut_instance|add_instance|Mux0~0\) # ((dut_input[7] & !dut_input(8)))))
-- dut_input(7) = DFFEAS(\dut_instance|add_instance|Mux0~1\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|Mux0~0\,
	datab => dut_input(9),
	datac => data(7),
	datad => dut_input(8),
	aclr => GND,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|Mux0~1\,
	regout => dut_input(7));

-- Location: LC_X13_Y8_N1
\dut_input[3]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|shiftedOp~3\ = (((dut_input[3] & dut_input(7))))
-- dut_input(3) = DFFEAS(\dut_instance|add_instance|shiftedOp~3\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|shiftedOp~3\,
	regout => dut_input(3));

-- Location: LC_X13_Y8_N3
\dut_input[0]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Mux7~0\ = (!dut_input[0] & ((dut_input(1) & ((\dut_instance|add_instance|shiftedOp~2\))) # (!dut_input(1) & (dut_input(4)))))
-- dut_input(0) = DFFEAS(\dut_instance|add_instance|Mux7~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	datab => dut_input(4),
	datac => data(0),
	datad => \dut_instance|add_instance|shiftedOp~2\,
	aclr => GND,
	sload => VCC,
	ena => \shift_reg~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|Mux7~0\,
	regout => dut_input(0));

-- Location: LC_X13_Y8_N7
\dut_input[4]\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|xoredOp~0\ = ((dut_input[4] $ (dut_input(0))))
-- dut_input(4) = DFFEAS(\dut_instance|add_instance|xoredOp~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|xoredOp~0\,
	regout => dut_input(4));
...
\dut_instance|add_instance|temp_diff~2\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|temp_diff~2_combout\ = (dut_input(7) $ (dut_input(3) $ (\dut_instance|add_instance|carry~1\)))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|temp_diff~2_combout\);

-- Location: LC_X10_Y8_N4
\dut_instance|add_instance|Mux4~0\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Mux4~0_combout\ = (dut_input(8) & (((dut_input(9))))) # (!dut_input(8) & (dut_input(3) $ (((dut_input(7) & dut_input(9))))))
...
\dut_instance|add_instance|shiftedOp~7\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|shiftedOp~7_combout\ = ((dut_input(1) & ((dut_input(4)))) # (!dut_input(1) & (dut_input(6))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|shiftedOp~7_combout\);

-- Location: LC_X13_Y8_N6
\dut_instance|add_instance|shiftedOp~9\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|shiftedOp~9_combout\ = (!dut_input(3) & ((dut_input(0) & ((\dut_instance|add_instance|shiftedOp~7_combout\))) # (!dut_input(0) & (dut_input(5)))))
...
PORT MAP (
	dataa => dut_input(3),
	datab => dut_input(5),
	datac => \dut_instance|add_instance|shiftedOp~7_combout\,
	datad => dut_input(0),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|shiftedOp~9_combout\);

-- Location: LC_X13_Y8_N8
\dut_instance|add_instance|shiftedOp~10\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|shiftedOp~10_combout\ = (dut_input(1) & (((\dut_instance|add_instance|shiftedOp~9_combout\)))) # (!dut_input(1) & ((dut_input(0) & (\dut_instance|add_instance|shiftedOp~9_combout\)) # (!dut_input(0) & ((dut_input(7))))))
...
PORT MAP (
	dataa => dut_input(1),
	datab => dut_input(0),
	datac => \dut_instance|add_instance|shiftedOp~9_combout\,
	datad => dut_input(7),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|shiftedOp~10_combout\);

-- Location: LC_X10_Y8_N8
\dut_instance|add_instance|Mux4~1\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Mux4~1_combout\ = (dut_input(8) & ((\dut_instance|add_instance|Mux4~0_combout\ & ((\dut_instance|add_instance|shiftedOp~10_combout\))) # (!\dut_instance|add_instance|Mux4~0_combout\ & 
-- (\dut_instance|add_instance|temp_diff~2_combout\)))) # (!dut_input(8) & (((\dut_instance|add_instance|Mux4~0_combout\))))
...
PORT MAP (
	dataa => dut_input(8),
	datab => \dut_instance|add_instance|temp_diff~2_combout\,
	datac => \dut_instance|add_instance|Mux4~0_combout\,
	datad => \dut_instance|add_instance|shiftedOp~10_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|Mux4~1_combout\);
...
-- Equation(s):
-- \shift_reg~3_combout\ = ((\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_cdr~0_combout\ & (\io~regout\ & !\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\)))
...
\datau[7]\ : maxv_lcell
-- Equation(s):
-- datau(7) = DFFEAS((\shift_reg~3_combout\ & (\dut_instance|add_instance|Mux0~1\)) # (!\shift_reg~3_combout\ & (((!\shift_reg~2_combout\ & datau(7))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|Mux0~1\,
...
\datau[6]~6\ : maxv_lcell
-- Equation(s):
-- \datau[6]~6_combout\ = ((\dut_instance|add_instance|Mux0~0\) # ((dut_input(6) & !dut_input(8))))
...
PORT MAP (
	dataa => dut_input(6),
	datac => dut_input(8),
	datad => \dut_instance|add_instance|Mux0~0\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \datau[6]~6_combout\);

-- Location: LC_X9_Y7_N8
\datau[4]~3\ : maxv_lcell
-- Equation(s):
-- \datau[4]~3_combout\ = (\io~regout\ & ((\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_udr~0_combout\)) # 
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \datau[4]~3_combout\);

-- Location: LC_X14_Y7_N0
\datau[6]\ : maxv_lcell
-- Equation(s):
-- datau(6) = DFFEAS((\shift_reg~3_combout\ & (!dut_input(9) & ((\datau[6]~6_combout\)))) # (!\shift_reg~3_combout\ & (((datau(7))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[4]~3_combout\, , , , )
...
PORT MAP (
	...
	aclr => GND,
	ena => \datau[4]~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => datau(6));

-- Location: LC_X14_Y7_N5
\datau[5]~4\ : maxv_lcell
-- Equation(s):
-- \datau[5]~4_combout\ = ((\dut_instance|add_instance|Mux0~0\) # ((dut_input(5) & !dut_input(8))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \datau[5]~4_combout\);

-- Location: LC_X14_Y7_N6
\datau[5]\ : maxv_lcell
-- Equation(s):
-- datau(5) = DFFEAS((\shift_reg~3_combout\ & (!dut_input(9) & ((\datau[5]~4_combout\)))) # (!\shift_reg~3_combout\ & (((datau(6))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[4]~3_combout\, , , , )
...
\datau[4]~1\ : maxv_lcell
-- Equation(s):
-- \datau[4]~1_combout\ = ((\dut_instance|add_instance|Mux0~0\) # ((!dut_input(8) & dut_input(4))))
...
-- pragma translate_on
PORT MAP (
	datab => \dut_instance|add_instance|Mux0~0\,
	datac => dut_input(8),
	datad => dut_input(4),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\datau[4]\ : maxv_lcell
-- Equation(s):
-- datau(4) = DFFEAS((\shift_reg~3_combout\ & (!dut_input(9) & ((\datau[4]~1_combout\)))) # (!\shift_reg~3_combout\ & (((datau(5))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \datau[4]~3_combout\, , , , )
...
\datau[3]\ : maxv_lcell
-- Equation(s):
-- datau(3) = DFFEAS((\shift_reg~2_combout\ & (((datau(4))))) # (!\shift_reg~2_combout\ & (datau(3))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , \dut_instance|add_instance|Mux4~1_combout\, , , 
-- \shift_reg~3_combout\)
...
PORT MAP (
	...
	datab => datau(3),
	datac => \dut_instance|add_instance|Mux4~1_combout\,
	datad => datau(4),
	aclr => GND,
...
\dut_instance|add_instance|temp_diff~1\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|temp_diff~1_combout\ = \dut_instance|add_instance|carry~0\ $ (dut_input(6) $ (((dut_input(2)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|temp_diff~1_combout\);

-- Location: LC_X10_Y8_N6
\dut_instance|add_instance|Mux5~0\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Mux5~0_combout\ = (dut_input(8) & ((\dut_instance|add_instance|temp_diff~1_combout\) # ((dut_input(9))))) # (!dut_input(8) & (((!dut_input(9) & dut_input(2)))))
...
PORT MAP (
	dataa => dut_input(8),
	datab => \dut_instance|add_instance|temp_diff~1_combout\,
	datac => dut_input(9),
	datad => dut_input(2),
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\dut_instance|add_instance|xoredOp~1\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|xoredOp~1_combout\ = (dut_input(2) $ (((dut_input(6)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|xoredOp~1_combout\);

-- Location: LC_X13_Y9_N3
\dut_instance|add_instance|shiftedOp~6\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|shiftedOp~6_combout\ = (dut_input(3) & (dut_input(7))) # (!dut_input(3) & (((dut_input(5)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|shiftedOp~6_combout\);

-- Location: LC_X13_Y9_N2
\dut_instance|add_instance|shiftedOp~4\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|shiftedOp~4_combout\ = (((!dut_input(3) & dut_input(4))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|shiftedOp~4_combout\);

-- Location: LC_X13_Y9_N8
\dut_instance|add_instance|shiftedOp~5\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|shiftedOp~5_combout\ = (!dut_input(0) & ((dut_input(1) & ((\dut_instance|add_instance|shiftedOp~4_combout\))) # (!dut_input(1) & (dut_input(6)))))
...
PORT MAP (
	...
	datab => dut_input(1),
	datac => dut_input(0),
	datad => \dut_instance|add_instance|shiftedOp~4_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|shiftedOp~5_combout\);

-- Location: LC_X13_Y9_N9
\dut_instance|add_instance|shiftedOp~8\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|shiftedOp~8_combout\ = (\dut_instance|add_instance|shiftedOp~5_combout\) # ((\dut_instance|add_instance|shiftedOp~6_combout\ & (!dut_input(1) & dut_input(0))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|shiftedOp~6_combout\,
	datab => dut_input(1),
	datac => dut_input(0),
	datad => \dut_instance|add_instance|shiftedOp~5_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|shiftedOp~8_combout\);

-- Location: LC_X10_Y8_N9
\dut_instance|add_instance|Mux5~1\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Mux5~1_combout\ = (\dut_instance|add_instance|Mux5~0_combout\ & (((\dut_instance|add_instance|shiftedOp~8_combout\) # (!dut_input(9))))) # (!\dut_instance|add_instance|Mux5~0_combout\ & 
-- (\dut_instance|add_instance|xoredOp~1_combout\ & (dut_input(9))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|Mux5~0_combout\,
	datab => \dut_instance|add_instance|xoredOp~1_combout\,
	datac => dut_input(9),
	datad => \dut_instance|add_instance|shiftedOp~8_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\datau[2]\ : maxv_lcell
-- Equation(s):
-- datau(2) = DFFEAS((\shift_reg~2_combout\ & (datau(3))) # (!\shift_reg~2_combout\ & (((datau(2))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , \dut_instance|add_instance|Mux5~1_combout\, , , 
-- \shift_reg~3_combout\)
...
\dut_instance|add_instance|Mux6~0\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Mux6~0_combout\ = (dut_input(8) & (((dut_input(9))))) # (!dut_input(8) & (dut_input(1) $ (((dut_input(5) & dut_input(9))))))
...
\dut_instance|add_instance|shiftedOp~11\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|shiftedOp~11_combout\ = (dut_input(0) & ((\dut_instance|add_instance|shiftedOp~2\) # ((\dut_instance|add_instance|shiftedOp~4_combout\)))) # (!dut_input(0) & (((\dut_instance|add_instance|shiftedOp~3\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|shiftedOp~2\,
	datab => \dut_instance|add_instance|shiftedOp~3\,
	datac => dut_input(0),
	datad => \dut_instance|add_instance|shiftedOp~4_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|shiftedOp~11_combout\);

-- Location: LC_X13_Y9_N5
\dut_instance|add_instance|shiftedOp~12\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|shiftedOp~12_combout\ = (dut_input(1) & (((!dut_input(0) & \dut_instance|add_instance|shiftedOp~11_combout\)))) # (!dut_input(1) & ((dut_input(0) & ((\dut_instance|add_instance|shiftedOp~11_combout\))) # (!dut_input(0) & 
-- (dut_input(5)))))
...
PORT MAP (
	...
	datab => dut_input(1),
	datac => dut_input(0),
	datad => \dut_instance|add_instance|shiftedOp~11_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|shiftedOp~12_combout\);

-- Location: LC_X13_Y9_N1
\dut_instance|add_instance|temp_diff~0\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|temp_diff~0_combout\ = dut_input(5) $ (dut_input(1) $ (((dut_input(0) & !dut_input(4)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|temp_diff~0_combout\);

-- Location: LC_X13_Y9_N6
\dut_instance|add_instance|Mux6~1\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Mux6~1_combout\ = (dut_input(8) & ((\dut_instance|add_instance|Mux6~0_combout\ & (\dut_instance|add_instance|shiftedOp~12_combout\)) # (!\dut_instance|add_instance|Mux6~0_combout\ & 
-- ((\dut_instance|add_instance|temp_diff~0_combout\))))) # (!dut_input(8) & (\dut_instance|add_instance|Mux6~0_combout\))
...
PORT MAP (
	...
	datac => \dut_instance|add_instance|shiftedOp~12_combout\,
	datad => \dut_instance|add_instance|temp_diff~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\datau[1]\ : maxv_lcell
-- Equation(s):
-- datau(1) = DFFEAS((\shift_reg~2_combout\ & (datau(2))) # (!\shift_reg~2_combout\ & (((datau(1))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , \dut_instance|add_instance|Mux6~1_combout\, , , 
-- \shift_reg~3_combout\)
...
PORT MAP (
	...
	dataa => \shift_reg~2_combout\,
	datab => datau(2),
	datac => \dut_instance|add_instance|Mux6~1_combout\,
	datad => datau(1),
	aclr => GND,
	sload => \shift_reg~3_combout\,
	devclrn => ww_devclrn,
...
\dut_instance|add_instance|Mux7~3\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|Mux7~3_combout\ = ((dut_input(8) $ (dut_input(9))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|Mux7~3_combout\);

-- Location: LC_X14_Y7_N2
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS(((\dut_instance|add_instance|Mux7~3_combout\ & ((\dut_instance|add_instance|xoredOp~0\))) # (!\dut_instance|add_instance|Mux7~3_combout\ & (\dut_instance|add_instance|Mux7~2\))), 
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => \dut_instance|add_instance|Mux7~2\,
	datab => \dut_instance|add_instance|xoredOp~0\,
	datac => \datau[0]~0_combout\,
	datad => \dut_instance|add_instance|Mux7~3_combout\,
	aclr => GND,
	sload => \ALT_INV_shift_reg~3_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => datau(0));
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|Mux0~1\,
	oe => VCC,
