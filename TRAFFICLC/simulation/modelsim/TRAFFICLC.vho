...
-- Equation(s):
-- \TIME2|count\(13) = DFFEAS(((\TIME2|Add0~90_combout\ & ((!\TIME2|Equal0~9\)))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME2|Equal0~4\ = (\TIME2|count\(17) & (!\TIME2|count\(14) & (!D1_count[16] & \TIME2|count\(15))))
...
-- Equation(s):
-- \TIME2|count\(19) = DFFEAS((((\TIME2|Add0~65_combout\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME2|Equal0~3\ = (\TIME2|count\(18) & (!\TIME2|count\(19) & (!D1_count[20] & \TIME2|count\(21))))
...
-- Equation(s):
-- \TIME2|count\(22) = DFFEAS((!\TIME2|Equal0~9\ & (((\TIME2|Add0~40_combout\)))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME2|count\(25) = DFFEAS(((\TIME2|Add0~30_combout\ & ((!\TIME2|Equal0~9\)))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME2|Equal0~2\ = (\TIME2|count\(23) & (\TIME2|count\(22) & (!D1_count[24] & \TIME2|count\(25))))
...
-- Equation(s):
-- \TIME2|Equal0~1\ = (\TIME2|Equal0~0\ & (!\TIME2|count\(30) & (!D1_count[31] & \TIME1|Equal0~0\)))
...
PORT MAP (
	clk => \Clk~combout\,
	dataa => \TIME2|Equal0~0\,
	datab => \TIME2|count\(30),
	datac => \TIME2|Add0~20_combout\,
	datad => \TIME1|Equal0~0\,
	aclr => \Reset~combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \TIME2|Add0~20_combout\ = ((\TIME2|Add0~27\ $ (!\TIME2|count\(31))))
...
-- Equation(s):
-- \TIME2|Equal0~6\ = (\TIME2|count\(9) & (!\TIME2|count\(8) & (D1_count[6] & !\TIME2|count\(7))))
...
-- Equation(s):
-- \TIME2|Equal0~8_combout\ = (\TIME2|Equal0~4\ & (\TIME2|Equal0~6\ & (\TIME2|Equal0~7\ & \TIME2|Equal0~5\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \TIME2|Equal0~4\,
	datab => \TIME2|Equal0~6\,
...
\TIME2|S1\ : maxv_lcell
-- Equation(s):
-- \TIME2|Equal0~9\ = (\TIME2|Equal0~3\ & (\TIME2|Equal0~2\ & (\TIME2|Equal0~1\ & \TIME2|Equal0~8_combout\)))
...
PORT MAP (
	...
	datac => \TIME2|Equal0~1\,
	datad => \TIME2|Equal0~8_combout\,
	aclr => \Reset~combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \TIME2|count\(15) = DFFEAS((((\TIME2|Add0~75_combout\ & !\TIME2|Equal0~9\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME2|count\(18) = DFFEAS((((\TIME2|Add0~55_combout\ & !\TIME2|Equal0~9\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME1|Equal0~7\ = (!\TIME1|count\(8) & (!\TIME1|count\(7) & (C1_count[6] & !\TIME1|count\(9))))
...
-- Equation(s):
-- \TIME1|count\(21) = DFFEAS((((\TIME1|Add0~60_combout\ & !\TIME1|Equal0~10\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME1|Equal0~4\ = (\TIME1|count\(19) & (\TIME1|count\(21) & (!C1_count[18] & \TIME1|count\(20))))
...
-- Equation(s):
-- \TIME1|count\(23) = DFFEAS(((\TIME1|Add0~45_combout\ & ((!\TIME1|Equal0~10\)))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME1|Equal0~3\ = (\TIME1|count\(23) & (\TIME1|count\(22) & (!C1_count[24] & \TIME1|count\(25))))
...
-- Equation(s):
-- \TIME1|count\(28) = DFFEAS((((\TIME1|Add0~15_combout\))), GLOBAL(\Clk~combout\), !GLOBAL(\Reset~combout\), , , , , , )
...
-- Equation(s):
-- \TIME1|Equal0~1\ = (!\TIME1|count\(26) & (!\TIME1|count\(27) & (!C1_count[29] & !\TIME1|count\(28))))
...
-- Equation(s):
-- \TIME1|Equal0~2\ = (\TIME1|Equal0~1\ & (!\TIME1|count\(30) & (!C1_count[31] & \TIME1|Equal0~0\)))
...
-- Equation(s):
-- \TIME1|Equal0~9_combout\ = (\TIME1|Equal0~6\ & (\TIME1|Equal0~5\ & (\TIME1|Equal0~7\ & \TIME1|Equal0~8\)))
...
PORT MAP (
	...
	datab => \TIME1|Equal0~5\,
	datac => \TIME1|Equal0~7\,
...
\TIME1|S1\ : maxv_lcell
-- Equation(s):
-- \TIME1|Equal0~10\ = (\TIME1|Equal0~4\ & (\TIME1|Equal0~3\ & (\TIME1|Equal0~2\ & \TIME1|Equal0~9_combout\)))
...
PORT MAP (
	clk => \Clk~combout\,
	dataa => \TIME1|Equal0~4\,
	datab => \TIME1|Equal0~3\,
...
-- Equation(s):
-- \Y_Present.S1~regout\ = DFFEAS((\Y_Present.S1~regout\ & (((\Y_Present.S0~regout\ & \TIME2|S1~regout\)) # (!\TIME1|S1~regout\))) # (!\Y_Present.S1~regout\ & (\Y_Present.S0~regout\ & (\TIME2|S1~regout\))), GLOBAL(\Clk~combout\), VCC, , , , , 
-- \Reset~combout\, )
...
-- Equation(s):
-- \Y_Present.S2~regout\ = DFFEAS((\Y_Present.S1~regout\ & ((\TIME1|S1~regout\) # ((\Y_Present.S2~regout\ & !\TIME2|S1~regout\)))) # (!\Y_Present.S1~regout\ & (\Y_Present.S2~regout\ & (!\TIME2|S1~regout\))), GLOBAL(\Clk~combout\), VCC, , , , , 
-- \Reset~combout\, )
...
-- Equation(s):
-- \Y_Present.S3~regout\ = DFFEAS((\Y_Present.S2~regout\ & ((\TIME2|S1~regout\) # ((\Y_Present.S3~regout\ & !\TIME1|S1~regout\)))) # (!\Y_Present.S2~regout\ & (\Y_Present.S3~regout\ & ((!\TIME1|S1~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , 
-- \Reset~combout\, )
...
-- Equation(s):
-- \Y_Present.S4~regout\ = DFFEAS((\TIME2|S1~regout\ & (((\Y_Present.S3~regout\ & \TIME1|S1~regout\)))) # (!\TIME2|S1~regout\ & ((\Y_Present.S4~regout\) # ((\Y_Present.S3~regout\ & \TIME1|S1~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , \Reset~combout\, )
...
PORT MAP (
	...
	datab => \Y_Present.S4~regout\,
	datac => \Y_Present.S3~regout\,
	datad => \TIME1|S1~regout\,
	aclr => GND,
	sclr => \Reset~combout\,
	devclrn => ww_devclrn,
...
-- Equation(s):
-- \Y_Present.S5~regout\ = DFFEAS((\TIME1|S1~regout\ & (\Y_Present.S4~regout\ & (\TIME2|S1~regout\))) # (!\TIME1|S1~regout\ & ((\Y_Present.S5~regout\) # ((\Y_Present.S4~regout\ & \TIME2|S1~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , \Reset~combout\, )
...
-- Equation(s):
-- \Y_Present.S6~regout\ = DFFEAS((\TIME2|S1~regout\ & (\Y_Present.S5~regout\ & ((\TIME1|S1~regout\)))) # (!\TIME2|S1~regout\ & ((\Y_Present.S6~regout\) # ((\Y_Present.S5~regout\ & \TIME1|S1~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , \Reset~combout\, )
...
-- Equation(s):
-- \Y_Present.S7~regout\ = DFFEAS((\Y_Present.S6~regout\ & ((\TIME2|S1~regout\) # ((\Y_Present.S7~regout\ & !\TIME1|S1~regout\)))) # (!\Y_Present.S6~regout\ & (((\Y_Present.S7~regout\ & !\TIME1|S1~regout\)))), GLOBAL(\Clk~combout\), VCC, , , , , 
-- \Reset~combout\, )
...
-- Equation(s):
-- \inst3|Mux1~0_combout\ = (!\Y_Present.S6~regout\ & ((\Y_Present.S7~regout\) # ((\Y_Present.S5~regout\) # (!\Y_Present.rst~regout\))))
...
-- Equation(s):
-- \inst2|Mux1~0_combout\ = (!\Y_Present.S4~regout\ & (((\Y_Present.S3~regout\) # (\Y_Present.S5~regout\)) # (!\Y_Present.rst~regout\)))
